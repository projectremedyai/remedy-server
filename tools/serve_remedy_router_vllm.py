...
def adapter_modules(args: argparse.Namespace) -> list[tuple[str, Path]]:
    ...
    modules = [
        ...
        (
            ...
            _resolve(root, args.contrast_adapter, "outputs/lamc-qwen3vl-32b-contrast-lora"),
        ),
        (
        ...
        (
            ...
            _resolve(root, args.heading_adapter, "outputs/lamc-qwen3vl-32b-heading-v2-lora"),
        ),
    ]
    if args.include_multitask:
        modules.append((
            ...
            _resolve(
                ...
                "outputs/lamc-qwen3vl-32b-multitask-contrast-weighted-lora",
            ),
        ))
    return modules
